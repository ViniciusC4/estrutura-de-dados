...
int main()
{
    ...
    // Variável para controlar o número de elementos inseridos
    // Insere 10 na posição e e incrementa n
    // Insere 40 na posição 1 e incrementa n
    ...
    for (int i = 0; i < n; i++)
    {                                            // Percorre os elementos já inseridos
